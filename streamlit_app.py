...
st.set_page_config(
    page_title="Análise de COVID-19",
    layout="wide",
    initial_sidebar_state="expanded",
)

# Definindo as páginas disponíveis no menu
def main():
    st.sidebar.title("Menu de Navegação")
    pages = ["Home", "Organização do Projeto", "Análise por cor/raça", "Análise por Escolaridade", "Análise por Estados",
             "Análise por Plano de Saúde", "Análise por Situação do Domicílio e Sexo", "Análise por Faixa Etária", "Análise por Faixa de Rendimento",
             "Evolução COVID por Semana", "Evolução COVID por Estado e Semana", "Conclusão e Recomendações"]

    page = st.sidebar.radio("Escolha a página", pages)

    if page == "Home":
        show_home()
    elif page == "Organização do Projeto":
        show_organizacao_projeto()
    elif page == "Análise por cor/raça":
        show_analise_cor_raca()
    elif page == "Análise por Escolaridade":
        show_analise_escolaridade()
    elif page == "Análise por Estados":
        show_analise_estados()
    elif page == "Análise por Plano de Saúde":
        show_analise_plano_saude()
    elif page == "Análise por Situação do Domicílio e Sexo":
        show_analise_domicilio_sexo()
    elif page == "Análise por Faixa Etária":
        show_analise_faixa_etaria()
    elif page == "Análise por Faixa de Rendimento":
        show_analise_faixa_rendimento()
    elif page == "Evolução COVID por Semana":
        show_analise_evolucao_semana()
    elif page == "Evolução COVID por Estado e Semana":
        show_analise_evolucao_estado_semana()
    elif page == "Conclusão e Recomendações":
        show_conclusao()
...
def show_organizacao_projeto():
    st.title("Organização do Projeto")
    st.markdown("""
...
# Página: Análise de Sintomas
def show_analise_cor_raca():
    st.title("Análise de Percentual de Pessoas com Sintomas e COVID Confirmado por Sexo e Cor/Raça")
    ...
    # Exibir a imagem
    st.image("./imagens/imagem1.png", caption="Sintomas e COVID Confirmado por Sexo e Cor/Raça")
...
# Página: Análise por Escolaridade
def show_analise_escolaridade():
    st.title("Análise de Distribuição por Escolaridade")
    ...
    # Exibir a imagem
    st.image("./imagens/imagem2.png", caption="Distribuição por Escolaridade")
...
# Página: Análise por Estados
def show_analise_estados():
    st.title("Análise dos Top 5 Estados com Pessoas que Tiveram Sintomas ou COVID-19 Confirmado")
    st.markdown("""
    ...
    st.image("imagens/imagem3.png", caption="Top 5 Estados com Sintomas ou COVID Confirmado")
...
# Página: Análise por Plano de Saúde
def show_analise_plano_saude():
    st.title("Análise da Relação entre Plano de Saúde e Atendimento em Posto de Saúde ou Hospital para Casos de COVID-19")
    ...
    st.image("imagens/imagem4.png", caption="Plano de Saúde e Atendimento em Posto de Saúde ou Hospital")
    st.markdown("""
        ### Principais Observações:
...
# Página: Análise por Situação do Domicílio e Sexo
def show_analise_domicilio_sexo():
    st.title("Análise de Pessoas com Sintomas e COVID-19 Confirmado por Situação do Domicílio e Sexo")
    st.markdown("""
    ...
    st.image("imagens/imagem5.png", caption="Situação do Domicílio e Sexo")
...
# Página: Análise por Faixa Etária
def show_analise_faixa_etaria():
    st.title("Análise de Pessoas com Sintomas e COVID-19 Confirmado por Faixa Etária e Sexo")
    st.markdown("""
    ...
    st.image("imagens/imagem6.png", caption="Faixa Etária e Sexo")
...
# Página: Análise por Faixa de Rendimento
def show_analise_faixa_rendimento():
    st.title("Análise de Pessoas com Sintomas e COVID-19 Confirmado por Faixa de Rendimento")
    ...
    st.image("imagens/imagem7.png", caption="Faixa de Rendimento")
...
# Página: Análise de Evolução por Semana
def show_analise_evolucao_semana():
    st.title("Evolução de Casos Confirmados de COVID-19 por Semana de Cada Mês")
    ...
    st.image("imagens/imagem8.png", caption="Evolução de Casos Confirmados por Semana de Cada Mês")
...
# Página: Análise de Evolução por Estado e Semana
def show_analise_evolucao_estado_semana():
    st.title("Evolução de Casos Confirmados de COVID-19 por Estado e Semana de Cada Mês (Top 5 Estados)")
    ...
    st.image("imagens/imagem9.png", caption="Evolução de Casos Confirmados por Estado e Semana de Cada Mês")
...
# Página: Conclusão
def show_conclusao():
    st.title("Conclusão e Recomendações")
